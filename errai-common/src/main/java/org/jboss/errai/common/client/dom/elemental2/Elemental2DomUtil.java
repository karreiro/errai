...
//        parent.appendChild(asHTMLElement(child.getElement()));
//
//        attach(child);
    }
     ...
     */
    public static HTMLElement asHTMLElement(final com.google.gwt.dom.client.Element gwtElement) {
     ...
     * @return The GWT Elemental2 HTMLElement
     */
    public static HTMLElement asHTMLElement(final org.jboss.errai.common.client.dom.HTMLElement htmlElement) {
        return Js.cast(htmlElement);
    }

    private static void attach(final Widget child) {
        final Elemental2Widget widget = Js.uncheckedCast(child);

        widget.onAttach();
    }

    private static class Elemental2Widget extends Widget {
